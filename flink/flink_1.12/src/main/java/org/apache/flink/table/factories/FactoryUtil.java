...
import xzw.shuai.flink.sink.clickhouse.demo.ClickhouseDynamicSinkFactory;
...
public final class FactoryUtil {
    ...
    private static List<Factory> discoverFactories(ClassLoader classLoader) {
        try {
            ...
            ServiceLoader<Factory> load = ServiceLoader.load(Factory.class, classLoader);
            load.iterator().forEachRemaining(result::add);

            // TODO 徐志文添加,
            result.add(new ClickhouseDynamicSinkFactory());
            return result;
